...
INSERT INTO SpotifyClone.plan(`name_plan`, price)
VALUES
  ('gratuito', 0.00),
  ('familiar', 7.99),
  ('universitário', 5.99),
  ('pessoal', 6.99);
INSERT INTO SpotifyClone.user(`name_user`, age, plan_id, date_assigned)
VALUES
...
VALUES
  ...
  (2, 10),
  (6, 10);
INSERT INTO SpotifyClone.song(`name_song`, album_id, duration)
VALUES
  ('Soul For Us', 1, 200),
